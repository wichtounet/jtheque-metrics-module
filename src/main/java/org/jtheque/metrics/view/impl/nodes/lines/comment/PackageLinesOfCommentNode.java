 ...
 */
public final class PackageLinesOfCommentNode extends AbstractResultTreeTableNode implements Decorated {
     ...
     */
    public PackageLinesOfCommentNode(Package srcPackage) {
        super();
    ...
    public Object getValueAt(int column) {
        ...
        switch (column) {
            case Columns.NAME:
                ...
                break;
            case Columns.TOTAL:
                res = srcPackage.getTotalNumberLinesOfComment();
                break;
            case Columns.AVERAGE:
                res = srcPackage.getAverageLinesOfCommentClass();
                break;
        }
