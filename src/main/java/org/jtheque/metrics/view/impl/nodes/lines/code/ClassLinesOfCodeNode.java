 ...
 */
public final class ClassLinesOfCodeNode extends AbstractResultTreeTableNode implements Decorated {
     ...
     */
    public ClassLinesOfCodeNode(Class srClass) {
        super();
    ...
    public Object getValueAt(int column) {
        ...
        switch (column) {
            case Columns.NAME:
                ...
                break;
            case Columns.TOTAL:
                res = srClass.getCodeLines();
                break;
            case Columns.AVERAGE:
                res = srClass.getAverageLinesOfCodeMethodConstructor();
                break;
        }
