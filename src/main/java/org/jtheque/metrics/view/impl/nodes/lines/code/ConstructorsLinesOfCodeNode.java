 ...
 */
public final class ConstructorsLinesOfCodeNode extends AbstractResultTreeTableNode {
    private final String name;
    private final int linesOfCode;
    private final double linesOfCodeConstructor;
     ...
     */
    public ConstructorsLinesOfCodeNode(String name, int linesOfCode, double linesOfCodeConstructor) {
        super();
