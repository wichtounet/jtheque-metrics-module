 ...
 */
public final class ClassPhysicalLinesNode extends AbstractResultTreeTableNode implements Decorated {
     ...
     */
    public ClassPhysicalLinesNode(Class srClass) {
        super();
    ...
    public Object getValueAt(int column) {
        ...
        switch (column) {
            case Columns.NAME:
                ...
                break;
            case Columns.TOTAL:
                res = srClass.getPhysicalLines();
                break;
            case Columns.AVERAGE:
                res = srClass.getAveragePhysicalLinesMethodConstructor();
                break;
        }
